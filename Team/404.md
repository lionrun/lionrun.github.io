...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://lionrun.live/Content/Front-theme/theme-assets/images/ico/favicon.ico">
    ...
    <!-- Bootstrap css -->
    <link href="https://lionrun.live/Content/assets/plugins/bootstrap-4.1.3/css/bootstrap.min.css" rel="stylesheet" />

    <!-- Style css -->
    <link href="https://lionrun.live/Content/assets/css/style.css" rel="stylesheet" />

    <!-- Default css -->
    <link href="https://lionrun.live/Content/assets/css/default.css" rel="stylesheet">

    <!-- Sidemenu css-->
    <link rel="stylesheet" href="https://lionrun.live/Content/assets/plugins/sidemenu/sidemenu.css">

    <!-- Bootstrap-daterangepicker css -->
    <link rel="stylesheet" href="https://lionrun.live/Content/assets/plugins/bootstrap-daterangepicker/daterangepicker.css">

    <!-- Bootstrap-datepicker css -->
    <link rel="stylesheet" href="https://lionrun.live/Content/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.css">

    <!-- Custom scroll bar css -->
    <link href="https://lionrun.live/Content/assets/plugins/scroll-bar/jquery.mCustomScrollbar.css" rel="stylesheet" />

    <!-- Sidemenu-repsonsive-tabs  css -->
    <link href="https://lionrun.live/Content/assets/plugins/sidemenu-responsive-tabs/css/sidemenu-responsive-tabs.css" rel="stylesheet">

    <!-- P-scroll css -->
    <link href="https://lionrun.live/Content/assets/plugins/p-scroll/p-scroll.css" rel="stylesheet" type="text/css">

    <!-- Nice-select css  -->
    <link href="https://lionrun.live/Content/assets/plugins/jquery-nice-select/css/nice-select.css" rel="stylesheet" />

    <!-- Select2 Plugin -->
    <link href="https://lionrun.live/Content/assets/plugins/select2/select2.min.css" rel="stylesheet" />

    <!-- News-Ticker css-->
    <link href="https://lionrun.live/Content/assets/plugins/newsticker/jquery.jConveyorTicker.css" rel="stylesheet" />

    <!-- Font icons css-->
    <link href="https://lionrun.live/Content/assets/css/icons.css" rel="stylesheet">

    <!-- Rightsidebar css -->
    <link href="https://lionrun.live/Content/assets/plugins/sidebar/sidebar.css" rel="stylesheet">

    <!-- Color-palette css-->
    <link rel="stylesheet" href="https://lionrun.live/Content/assets/css/skins.css" />
...
<body class="app">
    ...
    <!-- Loader -->
    <div id="loading">
        <img src="https://lionrun.live/Content/assets/images/other/loader.svg" class="loader-img" alt="Loader">
    </div>
                    ...
                    <div class="container-fluid">
                        <div class="d-flex">
                            <a class="header-brand" href="https://lionrun.github.io/Home-Dashboard">
                                <h3 style="margin-top: 16px;color: #141670;">lionrun</h3>
                    ...
                    <div class="first-sidemenu">
                        <div class="line-animations">
                            <ul class="resp-tabs-list hor_1">
                                 ...
                                 <li class="resp-tab-active active"><a href="/Home-Dashboard"><span class="side-menu__icon"></span><img src="https://lionrun.live/Content/assets/img/homepage.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Home"></a></li>
                                <li class="autopool"><a href="https://lionrun.github.io/Autopool"><span class="side-menu__icon"></span><img src="https://lionrun.live/Content/assets/img/m2.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Autopool"></a></li>
                                <li class="trans"><a href="https://lionrun.github.io/Transaction"><span class="side-menu__icon"></span><img src="https://lionrun.live/Content/assets/img/m3.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Transations"></a></li>
                                <li class="team2"><a href="https://lionrun.github.io/Team"><span class="side-menu__icon"></span><img src="https://lionrun.live/Content/assets/img/m4.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Team"></a></li>
                                <li class="media2"><a href="https://lionrun.github.io/Media"><span class="side-menu__icon"></span><img src="https://lionrun.live/Content/assets/img/m5.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Media"></a></li>
                             
                                <li class="logoutuser"><span class="side-menu__icon"></span><img src="https://lionrun.live/Content/assets/img/m6.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Log out"></li>
...
function getVariableData() {
    ...
    myContractInstance.methods.users(account).call().then(function (result1) {
            ...
            $('.currentuseridlinknew').val("https://link.trustwallet.com/open_url?coin_id=60&url=https:https://lionrun.github.io/signup?referralid=" + result1.id);
...
<script>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6  mt-2 mb-2 p-l-10">
                        ...
                        <a href="https://etherscan.io/address/0x3b66a3631148ae74db4d24ee078872ee71673058" class="text-success" target="_blank">
                            0x3b66a3631148ae74db4d24ee078872ee71673058 <i class="fa fa-external-link"></i>
                        </a>
                    </div>
                    <div class="col-md-6  mt-2 mb-2 text-center">
                        Copyright © 2020 <a href="#" class="fs-14 text-primary">https://lionrun.github.io/</a>
                    </div>
                </div>
            </div>
        </footer>
    ...
    <!-- Jquery-scripts -->
    <script src="https://lionrun.live/Content/assets/js/vendors/jquery-3.2.1.min.js"></script>

    <!-- Moment js-->
    <script src="https://lionrun.live/Content/assets/plugins/moment/moment.min.js"></script>

    <!-- Bootstrap-scripts js -->
    <script src="https://lionrun.live/Content/assets/js/vendors/bootstrap.bundle.min.js"></script>

    <!-- Sparkline JS-->
    <script src="https://lionrun.live/Content/assets/js/vendors/jquery.sparkline.min.js"></script>

    <!-- Bootstrap-daterangepicker js -->
    <script src="https://lionrun.live/Content/assets/plugins/bootstrap-daterangepicker/daterangepicker.js"></script>

    <!-- Bootstrap-datepicker js -->
    <script src="https://lionrun.live/Content/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.js"></script>

    <!-- Chart-circle js -->
    <script src="https://lionrun.live/Content/assets/js/vendors/circle-progress.min.js"></script>

    <!-- Rating-star js -->
    <script src="https://lionrun.live/Content/assets/plugins/rating/jquery.rating-stars.js"></script>

    <!-- Custom scroll bar js-->
    <script src="https://lionrun.live/Content/assets/plugins/scroll-bar/jquery.mCustomScrollbar.concat.min.js"></script>

    <!-- P-scroll js -->
    <script src="https://lionrun.live/Content/assets/plugins/p-scroll/p-scroll.js"></script>
    <script src="https://lionrun.live/Content/assets/plugins/p-scroll/p-scroll-leftmenu.js"></script>

    <!-- Sidemenu js-->
    <script src="https://lionrun.live/Content/assets/plugins/sidemenu/sidemenu.js"></script>

    <!-- Sidemenu-respoansive-tabs js -->
    <script src="https://lionrun.live/Content/assets/plugins/sidemenu-responsive-tabs/js/sidemenu-responsive-tabs.js"></script>

    <!-- Leftmenu js -->
    <script src="https://lionrun.live/Content/assets/js/left-menu.js"></script>

    <!--Newsticker js-->
    <script src="https://lionrun.live/Content/assets/plugins/newsticker/jquery.jConveyorTicker.js"></script>
    <script src="https://lionrun.live/Content/assets/js/newsticker.js"></script>

    <!-- Chart js-->
    <script src="https://lionrun.live/Content/assets/plugins/chart/chart.min.js"></script>

    <!-- Nice-select js-->
    <script src="https://lionrun.live/Content/assets/plugins/jquery-nice-select/js/jquery.nice-select.js"></script>
    <script src="https://lionrun.live/Content/assets/plugins/jquery-nice-select/js/nice-select.js"></script>

    <!-- Apexchart js-->
    <script src="https://lionrun.live/Content/assets/js/apexcharts.js"></script>

    <!-- Rightsidebar js -->
    <script src="https://lionrun.live/Content/assets/plugins/sidebar/sidebar.js"></script>

    <!-- Index js-->
    <script src="https://lionrun.live/Content/assets/js/index2.js"></script>

    <!-- Custom js-->
    <script src="https://lionrun.live/Content/assets/js/custom.js"></script>
    <!--LOgout Js-->
