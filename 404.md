...
$(document).ready(function () { 
  ...
  MyContract = new web3.eth.Contract(abi, address);
    ...
    <script src="https://lionrun.live/socialjs.js/"></script>
    <script>
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-form">
                    ...
                    <a href="https://1dapp.github.io/lionrunonepager.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 1</a>
                </div>
                ...
                <div class="purchase-token-btn text-center" style="margin-bottom:20px;margin-top:20px;">
                    <a href="https://1dapp.github.io/lionrun.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 3</a>
                </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 text-center d-flex d-block m-t-10">
                        <div class="row">
                            ...
                            <div class="socialjs col-lg-12 m-t-10">
                                ...
                                <a class="sharebutton telegram btn" target="_blank" style="background-color:#0088cc;color:white" href="https://t.me/lionrunV3"><i class="fa fa-telegram"></i> </a>
                ...
                <div class="login100-more ">
                    <div class="col-lg-12 m-t-30">
                        <a href="/">  <img src="https://1dapp.github.io/signup/assets/img/lionrun.png" style="" class="w-100" /></a>
                    </div>
