...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/lionrun.png">
...
function SigninPage(){
    ...
    //                $.notify({
    //                    icon: 'https://lionrun.github.io/signup/assets/img/lionrun.png',
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-form">
                    ...
                    <a href="https://lionrun.github.io/bullrunonepager.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 1</a>
                </div>
                ...
                <div class="purchase-token-btn text-center" style="margin-bottom:20px;margin-top:20px;">
                    <a href="https://lionrun.github.io/bullrun.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 3</a>
                </div>
                ...
                <div class="login100-more ">
                    <div class="col-lg-12 m-t-30">
                        <a href="/">  <img src="https://lionrun.github.io/signup/assets/img/lionrun.png" style="" class="w-100" /></a>
                    </div>
